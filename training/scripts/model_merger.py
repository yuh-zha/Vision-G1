...
parser.add_argument('--hf_model_path', type=str, default=None, help="The path for the huggingface model")
parser.add_argument(
    '--local_dir',
    type=str,
    required=True,
...
if not args.hf_model_path:
    args.hf_model_path = os.path.join(args.local_dir, 'huggingface')
